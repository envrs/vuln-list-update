...
CVE is composed of several different repositories that work together:
- [CVE](https://github.com/cvedb/cve) is the client side, user facing, command line tool.
- [vuln-list](https://github.com/cvedb/vuln-list) is a vulnerabilities database, aggregated from different sources, and normalized for easy consumption. This of this as the "server" side of the cve command line tool. **There should be no pull requests to this repo** 
- [vuln-list-update](https://github.com/cvedb/vuln-list-update) is the code that maintains the vuln-list database.
- [fanal](https://github.com/cvedb/fanal) is a library for extracting system information containers. It is being used by cve to find testable subjects in the container image.
